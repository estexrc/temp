        ...
        <div className={styles.dashboard}>
            ...
            <header className={styles.header}>
                <div className={`container ${styles.headerContent}`}>
                    ...
                    <div className={styles.searchBar}>
                        <svg xmlns="http://www.w3.org/2000/svg" className={styles.searchIcon} width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                        <input type="text" placeholder="Buscar trabajos..." className={styles.searchInput} />
                    </div>

                    <div className={styles.userActions}>
                        <button className={`${styles.iconButton} ${styles.mobileSearchBtn}`}>
            ...
            <main className="container">
                ...
                <section className={styles.welcome}>
                    <h1 className={styles.welcomeTitle}>Hola, Juan 👋</h1>
                    <p className={styles.welcomeSubtitle}>Hay 12 nuevos trabajos cerca de ti hoy.</p>
                </section>
                ...
                <div className={styles.filters}>
                    <button className={`${styles.filterChip} ${styles.active}`}>Para ti</button>
                    <button className={styles.filterChip}>Urgente 🔥</button>
                    <button className={styles.filterChip}>Cerca de mí</button>
                    <button className={styles.filterChip}>Mejor pagados</button>
                    <button className={styles.filterChip}>Remoto</button>
                </div>
                        ...
                        <div key={job.id} className={styles.jobCard}>
                            <div className={styles.jobHeader}>
                                ...
                                <div className={styles.priceTag}>
                                    {job.price} <span style={{ fontSize: '0.7em', opacity: 0.8 }}>{job.type}</span>
                                </div>
                            </div>
